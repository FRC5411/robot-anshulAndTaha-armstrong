...
public class ButtonMap {
    ...
    public static class Objects {
        /* Input objects */
        public static final CommandXboxController DRIVER_CONTROLLER = new CommandXboxController(Map.DRIVER_CONTROLLER_PORT);
        public static final CommandGenericHID OPERATOR_CONTROLLER = new CommandGenericHID(Map.OPERATOR_CONTROLLER_PORT);
