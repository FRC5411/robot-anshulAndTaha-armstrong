...
public class DriveVars {
  ...
  public static final class Constants {
    ...
    public static final double SCALED_CF =
        Units.inchesToMeters(1 / GEAR_RATIO * 2 * Math.PI * WHEEL_RADIUS_M) * (2.16 / 0.548);
    ...
    // Vision
    public static final Vector<N3> VISION_MEASUREMENT_STD_DEV =
        VecBuilder.fill(0.1, 0.1, Math.toRadians(200));
  }
  ...
  public static final class Objects {
    /* Motors */
    public static final CANSparkMax LEFT_FRONT_MOTOR =
        Configs.NEO(Constants.LEFT_FRONT_ID, Constants.LEFT_INVERT);
    public static final CANSparkMax LEFT_BACK_MOTOR =
        Configs.NEO(Constants.LEFT_BACK_ID, Constants.LEFT_INVERT, LEFT_FRONT_MOTOR);
    public static final CANSparkMax RIGHT_FRONT_MOTOR =
        Configs.NEO(Constants.RIGHT_FRONT_ID, Constants.RIGHT_INVERT);
    public static final CANSparkMax RIGHT_BACK_MOTOR =
        Configs.NEO(Constants.RIGHT_BACK_ID, Constants.RIGHT_INVERT, RIGHT_FRONT_MOTOR);

    /* Encoders */
    public static final RelativeEncoder LEFT_FRONT_ENCODER =
        Configs.RelativeEncoder(LEFT_FRONT_MOTOR, Constants.SCALED_CF);
    public static final RelativeEncoder LEFT_BACK_ENCODER =
        Configs.RelativeEncoder(LEFT_BACK_MOTOR, Constants.SCALED_CF);
    public static final RelativeEncoder RIGHT_FRONT_ENCODER =
        Configs.RelativeEncoder(RIGHT_FRONT_MOTOR, Constants.SCALED_CF);
    public static final RelativeEncoder RIGHT_BACK_ENCODER =
        Configs.RelativeEncoder(RIGHT_BACK_MOTOR, Constants.SCALED_CF);

    /* Controllers */
    public static final RamseteController DRIVE_RAMSETE_CONTROLLER =
    ...
    /* Drive */
    public static final DifferentialDrive ROBOT_DRIVE =
        new DifferentialDrive(LEFT_FRONT_MOTOR, RIGHT_FRONT_MOTOR);

    /* Odometry */
    public static final AHRS NAVX = new AHRS();

    public static final DifferentialDrivePoseEstimator ROBOT_POSE_ESTIMATOR =
  ...
  public static final class Simulation {
    ...
    public static final LinearSystem<N2, N2, N2> DRIVE_SYSTEM =
        LinearSystemId.identifyDrivetrainSystem(1.98, 0.2, 1.5, 0.3);

    public static final DifferentialDrivetrainSim DRIVE_SIMULATOR =
    ...
    public static final AnalogGyroSim GYRO_SIMULATOR = new AnalogGyroSim(new AnalogGyro(0));
  }
}
