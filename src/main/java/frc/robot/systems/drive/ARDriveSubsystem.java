...
public class ARDriveSubsystem extends SubsystemBase {
  private ARDriveIO IO;
  private ARDriveIOSim simIO;

  public ARDriveSubsystem() {
    IO = new ARDriveIO();
    simIO = new ARDriveIOSim();
  }

  public Command getAutonomousCommand(String trajectory, boolean useColor, HashMap<String, Command> map, ARDriveSubsystem robotDrive) {
