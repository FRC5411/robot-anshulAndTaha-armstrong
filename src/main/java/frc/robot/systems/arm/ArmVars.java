...
public class ArmVars {
  ...
  public static final class Objects {
    /* Physical objects */
    public static final CANSparkMax ARM_MOTOR =
        Configurations.SparkMax(
            Constants.ARM_ID,
            MotorType.kBrushless,
            Constants.ARM_INVERTED,
            Constants.ARM_CURRENT_LIMIT,
            Constants.ARM_IDLE_MODE,
            1.0);
    public static final Encoder ARM_ENCODER =
        Configurations.Encoder(
            Constants.ENCODER_PORTS[0],
            Constants.ENCODER_PORTS[1],
            Constants.ARM_ENCODER_DISTANCE_PER_PULSE,
            false);

    /* Arm controllers */
    public static final TrapezoidProfile.Constraints ARM_CONSTRAINTS =
        new TrapezoidProfile.Constraints(Constants.ARM_VEL_PROFILE, Constants.ARM_ACCEL_PROFILE);

    public static final ProfiledPIDController ARM_CONTROLLER =
        new ProfiledPIDController(
            Constants.CONTROLLER_P,
            Constants.CONTROLLER_I,
            Constants.CONTROLLER_D,
            ARM_CONSTRAINTS);

    public static final ArmFeedforward ARM_FEEDFORWARD =
        new ArmFeedforward(
            Constants.FEEDFORWARD_S,
            Constants.FEEDFORWARD_G,
            Constants.FEEDFORWARD_V,
            Constants.FEEDFORWARD_A);
  }
  ...
  public static final class Simulation {
    ...
    /* Simulation objects */
    public static final SingleJointedArmSim SIM_ARM =
    ...
    public static final MechanismRoot2d SIM_ARM_PIVOT =
        SIM_ARM_MECH2D.getRoot("ArmPivot", 30.0, 21);
    public static final MechanismLigament2d SIM_ARM_TOWER =
        SIM_ARM_PIVOT.append(new MechanismLigament2d("ArmTower", 21, -90));

    /* Complete visualiser */
    public static final MechanismLigament2d SIM_ARM_VISUAL_MECH2D =
        SIM_ARM_PIVOT.append(
