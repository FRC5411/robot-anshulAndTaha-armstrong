...
public class IntakeVars {
  ...
  public static class Objects {
    /* Motor */
    public static final CANSparkMax INTAKE_MOTOR =
        Configurations.SparkMax(
            Constants.INTAKE_ID,
            MotorType.kBrushless,
            Constants.INTAKE_INVERTED,
            Constants.INTAKE_CURRENT_LIMIT,
            Constants.INTAKE_IDLE_MODE,
            1.0);

    public static final RelativeEncoder INTAKE_ENCODER =
        Configurations.SparkMaxRelativeEncoder(INTAKE_MOTOR, 1.0, 1.0);

    public static LinearFilter INTAKE_LIN_FILTER =
        LinearFilter.movingAverage(Constants.FILTER_SAMPLES);
  }
